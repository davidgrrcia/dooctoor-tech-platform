      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.header}>
          <View style={styles.headerRow}>
            <View style={styles.headerTitleBlock}>
              ...
              <ThemedText style={styles.headerSubtitle}>Citas y eventos médicos</ThemedText>
            </View>
              ...
              <View key={`${d.label}-${idx}`} style={styles.dayCell}>
                {d.current ? (
                  <View style={styles.currentDayCircle}>
                    <ThemedText style={styles.currentDayText}>{d.label}</ThemedText>
                  </View>
                ) : (
                  <ThemedText style={[styles.dayText, d.dim && styles.dayTextDim]}>{d.label}</ThemedText>
                )}
                {d.dot && (
                  <View
                    style={[
                      styles.dayDot,
                      d.dot === 'orange' ? styles.dotOrange : d.dot === 'pink' ? styles.dotPink : styles.dotBlue,
                    ]}
                  />
                )}
              </View>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.cardBody}>
              <View style={styles.cardHeaderRow}>
                <ThemedText style={styles.cardTitle}>Chequeo General - Mike</ThemedText>
                <ThemedText style={styles.cardTime}>10:30 AM</ThemedText>
              </View>
              <ThemedText style={styles.cardMeta}>Dr. García • Clínica Central</ThemedText>
              <ThemedText style={styles.cardMeta}>Revisión anual programada</ThemedText>
            </View>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.cardBody}>
              <View style={styles.cardHeaderRow}>
                <ThemedText style={styles.cardTitle}>Vacunación - Emma</ThemedText>
                <ThemedText style={styles.cardTime}>18 Mar</ThemedText>
              </View>
              <ThemedText style={styles.cardMeta}>Dr. López • 2:00 PM</ThemedText>
              <ThemedText style={styles.cardMeta}>Vacuna anual contra la gripe</ThemedText>
            </View>
          </View>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.cardBody}>
              <View style={styles.cardHeaderRow}>
                <ThemedText style={styles.cardTitle}>Control Oftalmológico - Sarah</ThemedText>
                <ThemedText style={styles.cardTime}>21 Mar</ThemedText>
              </View>
              <ThemedText style={styles.cardMeta}>Dr. Martínez • 4:15 PM</ThemedText>
              <ThemedText style={styles.cardMeta}>Revisión de la vista anual</ThemedText>
            </View>
          </View>
        </View>
      </ScrollView>
